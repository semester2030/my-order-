...
mixin _$FeedState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<FeedItem> items, int page, bool hasMore)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<FeedItem> items, int page, bool hasMore)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<FeedItem> items, int page, bool hasMore});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'FeedState.loaded(items: $items, page: $page, hasMore: $hasMore)';
  }
