...
class __$$LoadedImplCopyWithImpl<$Res>
    extends _$VendorStateCopyWithImpl<$Res, _$LoadedImpl>
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(this.vendor, final List<MenuItem> menuItems)
  ...
  @override
  String toString() {
    return 'VendorState.loaded(vendor: $vendor, menuItems: $menuItems)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, vendor, const DeepCollectionEquality().hash(_menuItems));
...
abstract class _Loaded implements VendorState {
  const factory _Loaded(final Vendor vendor, final List<MenuItem> menuItems) =
      _$LoadedImpl;
