...
mixin _$SearchState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<SearchResult> results) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<SearchResult> results)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<SearchResult> results) : _results = results;
...
abstract class _Loaded implements SearchState {
  const factory _Loaded(final List<SearchResult> results) = _$LoadedImpl;
