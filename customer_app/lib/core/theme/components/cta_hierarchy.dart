...
/// CTA Button Hierarchy - 3 levels to prevent visual fatigue
class CTAHierarchy {
  CTAHierarchy._();

  // Primary CTA - Main action (Sunset Orange)
  ...
  // Secondary CTA - Secondary action (Charcoal + White text)
  ...
  // Tertiary CTA - Text only (Orange text, no background)
  ...
  // Gold CTA - Only for premium/highlight actions (limited use)
