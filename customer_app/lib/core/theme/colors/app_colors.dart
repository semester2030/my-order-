...
/// Primary color palette - Sunset Premium
class AppColors {
  AppColors._();
  ...
  static const Color warmSurface = Color(0xFFFAF7F2); // Warm beige
  static const Color warmDivider = Color(0xFFEFE6D8); // Warm light beige
  static const Color warmBackground = Color(0xFFFFFBF5); // Very light warm
  ...
  static const Color videoOverlay = Color(0x66000000); // 40% opacity
  static const Color videoText = Color(0xFFFFFFFF);
  static const Color videoControlBackground = Color(0x99000000); // 60% opacity
  ...
  // Semantic colors (delegated to SemanticColors for consistency)
