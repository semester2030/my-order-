...
class SemanticColors {
  ...
  static const Color badgePremium = Color(0xFFD4AF37); // Slightly darker gold for better contrast
  ...
  static Color goldWithOpacity(double opacity) {
    return const Color(0xFFFFD700).withValues(alpha: opacity);
  }

  // Gold with shadow color (for text on light backgrounds)
  static const Color goldShadow = Color(0x80000000); // 50% black for shadow
}
