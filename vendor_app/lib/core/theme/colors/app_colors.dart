...
/// Primary color palette - Sunset Premium (aligned with customer app).
class AppColors {
  AppColors._();
  ...
  static const Color videoOverlay = Color(0x66000000);
  static const Color videoText = Color(0xFFFFFFFF);
  static const Color videoControlBackground = Color(0x99000000);
