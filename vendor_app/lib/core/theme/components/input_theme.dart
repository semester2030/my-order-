...
class InputTheme {
  ...
  static InputDecorationTheme defaultTheme = InputDecorationTheme(
    ...
    focusedErrorBorder: OutlineInputBorder(
      borderRadius: AppRadius.mdAll,
      borderSide: BorderSide(color: SemanticColors.error, width: 2.0),
    ),
    disabledBorder: OutlineInputBorder(
      borderRadius: AppRadius.mdAll,
      borderSide: BorderSide(color: AppColors.disabled, width: 1.0),
    ),
    labelStyle: TextStyles.bodyMedium.copyWith(color: AppColors.textSecondary),
    hintStyle: TextStyles.bodyMedium.copyWith(color: AppColors.textTertiary),
    errorStyle: TextStyles.bodySmall.copyWith(color: SemanticColors.error),
  );
}
