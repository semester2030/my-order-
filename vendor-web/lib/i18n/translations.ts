...
export const translations = {
  ar: {
    ...
    register: {
      ...
      coordinatesHint: 'يفضّل الضغط على الزر أدناه لتحديد موقعك تلقائياً — أسرع وأدق.',
      useBrowserLocation: 'استخدام موقعي من المتصفح',
      gettingLocation: 'جاري تحديد الموقع…',
      needLocationOrManual:
        'حدّد موقعك: استخدم الزر أعلاه أو افتح «إدخال يدوي» وأكمل الإحداثيات.',
      manualCoordinates: 'إدخال خط العرض والطول يدوياً',
      hideManualCoordinates: 'إخفاء الإحداثيات اليدوية',
      mapsPasteHint: 'للإدخال اليدوي: من Google Maps اضغط على موقعك ثم انسخ الرقمين.',
      noBrowserGeolocation: 'المتصفح لا يدعم تحديد الموقع — أدخل الإحداثيات يدوياً.',
      browserLocationDenied: 'تم رفض الوصول للموقع — جرّب يدوياً أو صلاحيات المتصفح.',
  ...
  en: {
    ...
    register: {
      ...
      latitude: 'Latitude',
      longitude: 'Longitude',
      coordinatesHint: 'Prefer the button below to set your location automatically — faster and more accurate.',
      useBrowserLocation: 'Use my location (browser)',
      gettingLocation: 'Getting location…',
      needLocationOrManual:
        'Set your location: use the button above or open manual entry and fill coordinates.',
      manualCoordinates: 'Enter latitude & longitude manually',
      hideManualCoordinates: 'Hide manual coordinates',
      mapsPasteHint: 'For manual entry: in Google Maps tap your place, then copy both numbers.',
      noBrowserGeolocation: 'Your browser does not support geolocation — enter coordinates manually.',
      browserLocationDenied: 'Location access was denied — try manual entry or browser permissions.',
