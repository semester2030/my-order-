...
export default function VendorsPage() {
  ...
  return (
    <>
      <PageHeader
        title="مقدّمو الخدمة"
        description="قائمة كل المزوّدين مع فلاتر. المسجّلون الجدد قبل اعتمادكم يظهرون في «طلبات التسجيل» (بانتظار الموافقة أو قيد المراجعة). هنا فلتر «قيد المراجعة» يعرض حالة under_review فقط — لا يشمل «بانتظار الموافقة»."
      />
      <Card>
        <CardHeader
