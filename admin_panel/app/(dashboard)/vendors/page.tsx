...
export default function VendorsPage() {
  ...
  return (
    <>
      <PageHeader
        title="مقدّمو الخدمة"
        description="طبّاخون منزلي/شعبي، شواء، مناسبات — فلاتر حسب الحالة والفئة. الطلبات الجديدة قبل الموافقة تظهر في «طلبات التسجيل» بالقائمة الجانبية (حالة بانتظار الموافقة)."
      />
      <Card>
        <CardHeader
